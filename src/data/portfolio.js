...
export const portfolioData = {
  personal: {
    ...
    email: "john@example.com", // Ganti dengan email Anda
    phone: "+62 812 3456 7890", // Ganti dengan nomor Anda
    location: "Jakarta, Indonesia", // Ganti dengan lokasi Anda
  ...
  projects: [
    {
      ...
      description: "Modern admin dashboard built with React and Tailwind CSS featuring real-time analytics and inventory management.",
      image: "https://via.placeholder.com/400x250/3B82F6/FFFFFF?text=E-Commerce+Dashboard",
    ...
    },
    {
      id: 2,
      title: "Weather App",
      description: "Responsive weather application with geolocation and 7-day forecast using OpenWeather API.",
    ...
    },
    {
      ...
      description: "Productivity app with drag-and-drop functionality and local storage integration.",
